<template>
    <div class="currentPlay">
        <div class="header fx_sp p_up">
            <div class="left fx p_line">
                <svg class="svg mr_1" aria-hidden="true" @touchstart="$router.go(-1)">
                    <use xlink:href="#icon-fanhui"></use>
                </svg>
                <div>
                    <p class="cr_wh">Nothing To Fear</p>
                    <p class="cr_no">Dex
